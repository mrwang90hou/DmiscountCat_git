package com.example.administrator.dmiscountcat.activity.goodsDetail;
...
import com.example.administrator.dmiscountcat.Adapter.goodsDetail.VPagerFragmentAdapter;
import com.example.administrator.dmiscountcat.Bean.goodsDetail.Brand;
import com.example.administrator.dmiscountcat.Bean.goodsDetail.Specification;
import com.example.administrator.dmiscountcat.Bean.goodsDetail.ViewBundle;
import com.example.administrator.dmiscountcat.Fragment.goodsDetail.GraphicDetailsFragment;
import com.example.administrator.dmiscountcat.Fragment.goodsDetail.ProductEvalInfoFragment;
import com.example.administrator.dmiscountcat.Fragment.goodsDetail.ProductWillFragment;
import com.example.administrator.dmiscountcat.utils.ClickUtil;
import com.example.administrator.dmiscountcat.view.goodsDetail.ChildAutoHeightViewPager;
import com.example.administrator.dmiscountcat.view.goodsDetail.FlowLayout;
import com.example.administrator.dmiscountcat.view.goodsDetail.MyScrollView;
...
//                bannerList.add(R.drawable.product_banner_eight);
            bannerList.add(R.mipmap.product_details01);
        }
//         初始化商品详情
        if (detailList == null)
        ...
        for (int i = 0; i < 6; i++) {
//            if (i == 0)
                detailList.add(R.mipmap.product_details01);
//            else if (i == 1)
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_share:// 分享
                Toast.makeText(ProductInfoActivity.this, "分享功能", Toast.LENGTH_SHORT).show();
                break;
...
//                        Intent intent = new Intent(MainActivity.this, BrandActivity.class);
                        Toast.makeText(ProductInfoActivity.this, "跳转品牌页面" + value.getBrand_name(), Toast.LENGTH_SHORT).show();
                    }
                });
                    ...
                    public void onClick(View v) {
                        ...
                        for (int i = 0; i < datas.size(); i++) {
                            ...
                            if (specification.getId() == tvTag) {
                                ...
                                tv.setTextColor(ProductInfoActivity.this.getResources().getColor(R.color.colorTitle));
                                // 刷新界面-发送广播/EventBus
                            } else {
                                ...
                                tagView.setTextColor(ProductInfoActivity.this.getResources().getColor(R.color.colorSomber));
                            }
                        }
