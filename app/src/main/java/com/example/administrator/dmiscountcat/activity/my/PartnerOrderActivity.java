...
public class PartnerOrderActivity extends BaseActivity implements View.OnClickListener{
    ...
    private void initUI() {
        ...
        titleText.setText(getResources(R.string.title_partner_order));
        titleText.setTextColor(getResources().getColor(R.color.white));
        tvRight = getViewById(R.id.tv_right);
        ivRight = getViewById(R.id.iv_right);
        ivRight.setVisibility(View.VISIBLE);
        tvRight.setVisibility(View.VISIBLE);
        tvRight.setText("全部");
        tvRight.setCompoundDrawablesRelative(null,null,null,null);
