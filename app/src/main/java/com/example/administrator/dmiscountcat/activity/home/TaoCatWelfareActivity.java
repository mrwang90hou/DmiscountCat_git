...
public class TaoCatWelfareActivity extends BaseActivity {
...
//    @Override
    protected int getFragmentContentId() {
        return R.layout.activity_home_page08_view;
    }
//
    @Override
    public void setContentView() {
        setContentView(R.layout.activity_home_page08_view);
    }
    ...
    public void initView() {
        ...
        titleText.setText(getResources(R.string.home_icon8));
